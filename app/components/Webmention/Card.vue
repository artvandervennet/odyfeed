  ...
  <article class="py-4 border-b border-gray-200 dark:border-gray-800 last:border-b-0">
    <div v-if="isLike" class="flex items-center gap-3">
      ...
      <div class="flex-1 min-w-0">
        <p class="text-sm">
          <a
              :href="webmention.author?.url || webmention.source"
              target="_blank"
      ...
      <UIcon name="i-heroicons-heart-solid" class="w-5 h-5 text-red-500 shrink-0"/>
    </div>
    ...
    <div v-else-if="isComment" class="flex gap-3">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div
            ...
            class="text-sm text-gray-700 dark:text-gray-300 wrap-break-word"
        >
