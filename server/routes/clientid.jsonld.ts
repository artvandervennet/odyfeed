...
export default defineEventHandler((event) => {
	try {
		...
		console.log('[ClientID] Serving client document')
		console.log('[ClientID] BASE_URL:', baseUrl)
		console.log('[ClientID] Client ID:', clientId)
		console.log('[ClientID] Redirect URI:', redirectUri)
		...
		console.error('[ClientID] Error serving client document:', error)
		throw createError({
			statusCode: 500,
			statusMessage: 'Failed to generate client document',
		})
	}
})
